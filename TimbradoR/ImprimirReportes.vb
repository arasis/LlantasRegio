...
Module ImprimirReportes
    ...
    Public Sub DocToPrint_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles DocToPrint.PrintPage
        ...
        nombre_empresa = New Font("Arial", 16, FontStyle.Bold)
        headfont = New Font("Arial", 9, FontStyle.Bold)
        FONTDESCR = New Font("Arial", 10, FontStyle.Regular)
        ...
        Do While nRowPos < DataGridViewToPrint.Rows.Count
            ...
            Else
                ...
                If NewPage Then
                    ...
                    e.Graphics.DrawImage(newImage2, 5, 5)
                    'titulo del reporte
    ...
    Public Sub DrawFooter(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal RowsPerPage As Int32)
        ...
        e.Graphics.DrawString(Now.ToLongDateString + " " + Now.ToShortTimeString, DataGridViewToPrint.Font, Brushes.Black, e.MarginBounds.Left, e.MarginBounds.Top + e.MarginBounds.Height + 14)

        ' Center - Page No. Info
        e.Graphics.DrawString(sPageNo, DataGridViewToPrint.Font, Brushes.Black, e.MarginBounds.Left + (e.MarginBounds.Width - e.Graphics.MeasureString(sPageNo, DataGridViewToPrint.Font, e.MarginBounds.Width).Width) / 2, e.MarginBounds.Top + e.MarginBounds.Height + 14)
